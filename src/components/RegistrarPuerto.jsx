                ...
                <h2 className="u-align-center u-custom-font u-font-raleway u-text u-text-custom-color-3 u-text-default u-text-1">Registro de Puertos</h2>
                    <form action="#" method="POST" className="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" source="custom" name="formDock" style={{ padding: '10px' }}>
                        <div className="u-form-group u-form-name">
                            ...
                            <input type="text" id="name-40e7" name="nameDock" className="u-border-1 u-border-grey-30 u-custom-font u-font-raleway u-input u-input-rectangle u-radius-10 u-text-custom-color-2 u-white u-input-1" required="" />
                        </div>
                        <div className="u-form-email u-form-group u-form-partition-factor-2">
                            ...
                            <input type="email" id="email-40e7" name="idDock" className="u-border-1 u-border-grey-30 u-custom-font u-font-raleway u-input u-input-rectangle u-radius-10 u-text-custom-color-2 u-white u-input-2" required="" />
                        </div>
                        <div className="u-form-group u-form-partition-factor-2 u-form-group-3">
                            ...
                            <input type="text" id="text-c25c" name="milesDock" className="u-border-1 u-border-grey-30 u-custom-font u-font-raleway u-input u-input-rectangle u-radius-10 u-text-custom-color-2 u-white u-input-3" required="required" />
                        </div>
                        <div className="u-form-group u-form-group-4">
                            ...
                            <input type="text" id="text-3800" name="cityDock" className="u-border-1 u-border-grey-30 u-custom-font u-font-raleway u-input u-input-rectangle u-radius-10 u-text-custom-color-2 u-white u-input-4" required="required" />
                        </div>
                        <div className="u-form-group u-form-group-5">
                            ...
                            <input type="text" id="text-c1c1" name="riverDock" className="u-border-1 u-border-grey-30 u-custom-font u-font-raleway u-input u-input-rectangle u-radius-10 u-text-custom-color-2 u-white u-input-5" required="required" />
                        </div>
