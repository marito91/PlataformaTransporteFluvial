                ...
                <div className="formRgs u-form u-form-1">
                    <form action="#" method="POST" className="u-clearfix u-inner-form" source="custom" name="formOrd" style={{ padding : '10px' }}>
                        <div className="u-form-group u-form-name">
                            ...
                            <input type="text" id="name-40e7" name="nameOrd" className="u-border-1 u-border-grey-30 u-custom-font u-font-raleway u-input u-input-rectangle u-radius-10 u-text-custom-color-2 u-white u-input-1" required="" />
                        </div>
                        <div className="u-form-email u-form-group u-form-partition-factor-4">
                            ...
                            <input type="email" placeholder="Height" id="email-40e7" name="heightOrd" className="u-border-1 u-border-grey-30 u-custom-font u-font-raleway u-input u-input-rectangle u-radius-10 u-text-custom-color-2 u-white u-input-2" required="" />
                        </div>
                        <div className="u-form-group u-form-partition-factor-4 u-form-group-3">
                            ...
                            <input type="text" id="text-c25c" name="widthOrd" className="u-border-1 u-border-grey-30 u-custom-font u-font-raleway u-input u-input-rectangle u-radius-10 u-text-custom-color-2 u-white u-input-3" placeholder="Width" required="required" />
                        </div>
                        <div className="u-form-group u-form-partition-factor-4 u-form-group-4">
                            ...
                            <input type="text" placeholder="Length" id="text-3800" name="lengthOrd" className="u-border-1 u-border-grey-30 u-custom-font u-font-raleway u-input u-input-rectangle u-radius-10 u-text-custom-color-2 u-white u-input-4" required="required" />
                        </div>
                        <div className="u-form-group u-form-partition-factor-4 u-form-group-5">
                            ...
                            <input type="text" placeholder="Weigth" id="text-bc62" name="weigthOrd" className="u-border-1 u-border-grey-30 u-custom-font u-font-raleway u-input u-input-rectangle u-radius-10 u-text-custom-color-2 u-white u-input-5" required="required" />
                        </div>
                        <div className="u-form-group u-form-group-6">
                            ...
                            <input type="text" id="text-c1c1" name="originDockOrd" className="u-border-1 u-border-grey-30 u-custom-font u-font-raleway u-input u-input-rectangle u-radius-10 u-text-custom-color-2 u-white u-input-6" required="required" />
                        </div>
                        <div className="u-form-group u-form-group-7">
                            ...
                            <input type="text" id="text-cd75" name="destinationDockOrd" className="u-border-1 u-border-grey-30 u-custom-font u-font-raleway u-input u-input-rectangle u-radius-10 u-text-custom-color-2 u-white u-input-7" required="required" />
                        </div>
                        <div className="u-form-group u-form-textarea u-form-group-8">
                            ...
                            <textarea rows="4" cols="50" id="textarea-236a" name="descriptionOrd" className="u-border-1 u-border-grey-30 u-custom-font u-font-raleway u-input u-input-rectangle u-radius-10 u-text-custom-color-2 u-white u-input-8" required="" placeholder="Ingrese una breve descripción del producto"></textarea>
                        </div>
                        ...
                        <div className="u-form-send-message u-form-send-success">Orden registrada con éxito.</div>
                        <div className="u-form-send-error u-form-send-message">No se pudo registrar la orden. Intente nuevamente.</div>
